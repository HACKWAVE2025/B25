...
const nurse = await User.findById(consDoc.nurseId).select('name').lean();
...
const nurseName = (nurse?.name || 'Nurse').split(/\s+/)[0];
...
module.exports = { createOrderForConsultation, verifyPaymentForConsultation,devMarkPaid };
